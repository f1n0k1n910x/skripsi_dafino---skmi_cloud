    ...
    <div class="dashboard-header">
        ...
        <div class="user-info">
            ...
            <img id="userInfoAvatar" 
              src="<?php echo htmlspecialchars(base_url($user['profile_picture'] ?? 'img/photo_profile.png')); ?>" 
              alt="User Avatar">
    ...
    <div class="dashboard-grid">
        ...
        <div class="card profile-card">
            ...
            <div class="profile-picture-container">
                <img id="profileCardPicture" src="<?php echo htmlspecialchars(base_url($user['profile_picture']) ?? 'img/photo_profile.png'); ?>" alt="Profile Picture">
